...
export default function PlacesFormPage() {
    ...
    async function savePlace(ev) {
        ...
        // Vérifier si la soumission a réussi (vous pouvez ajouter des vérifications supplémentaires si nécessaire)
        if (data) {
            // Redirection vers la page des places dans le compte après la soumission réussie
            window.location.href = 'http://localhost:5173/account/places';
        }
    }
    return (
                    ...
                    <form onSubmit={savePlace}>
                        ...
                        <input type="text" value={title} onChange={ev => setTitle(ev.target.value)} placeholder="tiltle, for example: My lovely appartement" />
                        {preInput('Adress', 'Adress to this place')}
